...
@CucumberOptions(format = { "pretty" }, features = "src//test//java//com//api//rest//features", glue = {
		"com.api.rest.stepdefinitions" }, tags = { "@hooks,@post,@postfail,@get,@put,@smokes" }, plugin = {
